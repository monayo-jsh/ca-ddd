...
public class QCart extends EntityPathBase<Cart> {
    ...
    private static final long serialVersionUID = 613682174L;
    ...
    public final com.clean.architecture.domain.user.entity.QUser user;
    ...
    public QCart(Class<? extends Cart> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.clean.architecture.domain.user.entity.QUser(forProperty("user")) : null;
    }
